...
class NacosClient(NacosClient):
    def __init__(self):
        self.base_url = 'https://api.nacosdb.com/'
...
if __name__ == "__main__":
    ...
    # c = NacosClient("172.26.22.201:30002", username='nacos', password='nacos123456')
    # c.request('GET', 'http://172.26.22.201:30002')